...
// GHSA-w865: a wazuh-states-* name outside the agent scope must be rejected.
...
// GHSA-w865: manager-governance indices are never reachable from an agent session.
